package net.mcreator.nightmare;
...
import net.mcreator.nightmare.init.NightmareModTabs;
import net.mcreator.nightmare.init.NightmareModSounds;
...
public class NightmareMod {
	public static final Logger LOGGER = LogManager.getLogger(NightmareMod.class);
	public static final String MODID = "nightmare";

	public NightmareMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		NightmareModSounds.REGISTRY.register(modEventBus);
		NightmareModBlocks.REGISTRY.register(modEventBus);
		NightmareModItems.REGISTRY.register(modEventBus);
		NightmareModEntities.REGISTRY.register(modEventBus);
		NightmareModTabs.REGISTRY.register(modEventBus);
