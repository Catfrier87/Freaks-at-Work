...
@EventBusSubscriber
public class PangeaBiomeLeaveDecorator extends LeaveVineDecorator {

	public static MapCodec<PangeaBiomeLeaveDecorator> CODEC = MapCodec.unit(PangeaBiomeLeaveDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dream_projection:pangea_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public PangeaBiomeLeaveDecorator() {
		super(0.25f);
	}
