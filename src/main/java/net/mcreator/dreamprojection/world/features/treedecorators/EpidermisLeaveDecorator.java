...
@EventBusSubscriber
public class EpidermisLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<EpidermisLeaveDecorator> CODEC = MapCodec.unit(EpidermisLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dream_projection:epidermis_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public EpidermisLeaveDecorator() {
		super(0.25f);
	}
