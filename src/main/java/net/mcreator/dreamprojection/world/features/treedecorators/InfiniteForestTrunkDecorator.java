...
@EventBusSubscriber
public class InfiniteForestTrunkDecorator extends TrunkVineDecorator {

	public static MapCodec<InfiniteForestTrunkDecorator> CODEC = MapCodec.unit(InfiniteForestTrunkDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dream_projection:infinite_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
