...
@EventBusSubscriber
public class InfiniteForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<InfiniteForestLeaveDecorator> CODEC = MapCodec.unit(InfiniteForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dream_projection:infinite_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public InfiniteForestLeaveDecorator() {
		super(0.25f);
	}
