...
@EventBusSubscriber
public class PangeaBiomeTrunkDecorator extends TrunkVineDecorator {

	public static MapCodec<PangeaBiomeTrunkDecorator> CODEC = MapCodec.unit(PangeaBiomeTrunkDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dream_projection:pangea_biome_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
