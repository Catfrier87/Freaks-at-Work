...
@EventBusSubscriber
public class EpidermisFruitDecorator extends CocoaDecorator {
	public static MapCodec<EpidermisFruitDecorator> CODEC = MapCodec.unit(EpidermisFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dream_projection:epidermis_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public EpidermisFruitDecorator() {
		super(0.2f);
	}
