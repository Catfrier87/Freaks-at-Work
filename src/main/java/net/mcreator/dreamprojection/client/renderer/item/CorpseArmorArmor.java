...
public class CorpseArmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final ResourceLocation armorTexture = ResourceLocation.parse("dream_projection:textures/models/armor/flesh_layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final ResourceLocation armorTexture = ResourceLocation.parse("dream_projection:textures/models/armor/flesh_layer_2.png");
