package net.mcreator.dreamprojection;
...
@Mod("dream_projection")
public class DreamProjectionMod {
	public static final Logger LOGGER = LogManager.getLogger(DreamProjectionMod.class);
	public static final String MODID = "dream_projection";

	public DreamProjectionMod(IEventBus modEventBus) {
