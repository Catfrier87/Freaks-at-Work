...
@EventBusSubscriber
public class DreamProjectionModBiomes {
	@SubscribeEvent
		...
		for (LevelStem levelStem : levelStemTypeRegistry.stream().toList()) {
			...
			if (dimensionType.is(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					addParameterPoint(parameters, new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-0.5f, 0.5f), Climate.Parameter.span(0f, 0.5f), Climate.Parameter.span(0.3f, 1f), Climate.Parameter.span(-0.5f, 0.5f),
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					((DreamProjectionModNoiseGeneratorSettings) (Object) noiseGenerator.settings.value()).setdream_projectionDimensionTypeReference(dimensionType);
				}
			}
		}
	}
	...
	private static SurfaceRules.RuleSource injectOverworldSurfaceRules(SurfaceRules.RuleSource currentRuleSource) {
		...
		customSurfaceRules
				.add(anySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("dream_projection", "wheatfield")), Blocks.WHEAT.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.DIRT.defaultBlockState()));
	...
	public interface DreamProjectionModNoiseGeneratorSettings {
		void setdream_projectionDimensionTypeReference(Holder<DimensionType> dimensionType);
	}
}